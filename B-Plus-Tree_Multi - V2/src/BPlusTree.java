        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (firstline) {
                    ...
                    if (i < num_keys) {
                        actualLeafNode.addData(Integer.parseInt(value[0]), new Data(value[1],Integer.parseInt(value[0])));
                        i++;
                    } else {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (firstline) {
                    ...
                    add(Integer.parseInt(value[0]), new Data(value[1],Integer.parseInt(value[0])));
                }
            }
        }
    }
